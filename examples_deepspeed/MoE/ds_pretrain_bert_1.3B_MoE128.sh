...
TRAIN_ITERS=50
#$(( ${TRAIN_TOKENS} * 3 / ${GLOBAL_BATCH_SIZE} / ${SEQ_LEN} ))
...
if [ "${USE_INTERNAL_DATA}" = "true" ]; then
    ...
    VOCAB_FILE=/home/xinglinpan/v630/examples/megatronlm/bert-large-uncased-vocab.txt
    DATA_PATH=/home/xinglinpan/v630/Megatron/book-bert_text_sentence
fi
###############################################################################
data_options=" \
...
MASTER_ADDR=ethgpu11
MASTER_PORT=6001
NNODES=8
NODE_RANK=$1
WORLD_SIZE=$(($GPUS_PER_NODE*$NNODES))
run_cmd="/home/xinglinpan/miniconda3/envs/lwxds093/bin/python -m torch.distributed.launch --nproc_per_node=4   --nnodes=${NNODES} --node_rank=${NODE_RANK} --master_addr=${MASTER_ADDR} --master_port=${MASTER_PORT} /home/xinglinpan/v630/examples/Megatron-DeepSpeed-main/pretrain_bert.py ${megatron_options} ${data_options} ${deepspeed_options}"
# echo ${run_cmd}
eval ${run_cmd}
set +x
