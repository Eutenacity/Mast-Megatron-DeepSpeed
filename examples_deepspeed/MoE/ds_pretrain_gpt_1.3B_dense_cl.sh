...
host="${HOSTNAME}"
NAME="gpt2-with-pile-${MODEL_SIZE}B-lr-${LR}-minlr-${MIN_LR}-bs-${GLOBAL_BATCH_SIZE}-gpus-${NUM_GPUS}-zero-${ZERO_STAGE}-mp-${MP_SIZE}-pp-${PP_SIZE}"
if [ "${NO_PP}" = "true" ]; then
    NAME="${NAME}-no_pp"
fi
...
VOCAB_PATH=/home/xinglinpan/v630/examples/megatronlm/gpt2-vocab.json
MERGE_PATH=/home/xinglinpan/v630/examples/megatronlm/gpt2-merges.txt
# Public the Pile dataset, can be downloaded at https://mystic.the-eye.eu/public/AI/pile_neox/
DATA_PATH=/datasets/BookCorpusDataset/BookCorpusDataset_text_document
###############################################################################
data_options=" \
...
run_cmd="deepspeed /home/xinglinpan/v630/examples/Megatron-DeepSpeed-main/pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options}"
echo ${run_cmd}
eval ${run_cmd}
