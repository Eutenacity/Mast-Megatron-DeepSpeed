...
def install(use_cuda, use_nccl):
    ext_libs = []
    ext_args = ['-Wno-sign-compare', '-Wno-unused-but-set-variable', '-Wno-terminate', '-Wno-unused-function', '-Wno-strict-aliasing','-I/home/wenxianglin/nccl_2.18.5-1+cuda12.2/nccl_2.18.5-1+cuda12.2_x86_64/include','/home/wenxianglin/spack/opt/spack/linux-ubuntu20.04-icelake/gcc-9.4.0/cuda-12.2.1-tmmwqiuhyroqiehokdrfzjp3or7n6mcr/include'] if pf.system() == 'Linux' else []
    if not use_cuda:
        use_nccl = False
    ...
    setup(
        ...
        ext_modules=[
            ...
            library_dirs=['/home/wenxianglin/spack/opt/spack/linux-ubuntu20.04-icelake/gcc-9.4.0/cuda-12.1.1-ez4loay3afejb6o3ml5p45sgr7curufu/lib64/stubs'],
            libraries=ext_libs,
